...
export const Admin = () => {
    ...
    const setQuizSubmitHandler = (e) => {
        ...
        if (!question) {
          ...
          try{
            const response = axios.post('https://hasquiz-api.herokuapp.com/api/questions',{
              question,
              answers,
              time
            })
        ...
        <div>
            ...
            <section style ={{marginTop: '30px'}}>
                ...
                >
                  ...
                  <p>{question}</p>
                  <input  
                  type="text" value={questionvalue} onChange={(event) => setQuestionValue(event.target.value)}
                  onKeyUp={(event) => {
                      if(event.key === "Enter"){
                  ...
                  <input className = 'options-area'
                  type="text" placeholder="Add Options" value={optionsInput}
                  onKeyUp={(event) => {
                ...
                <div className="tags_area">
                    ...
                    <RiHome3Fill/>All</span>
                
                <span className = 'trashcan' onClick={() => {
                    setQuestion(""); 
                    setOptions([])}}>
                    <IoMdTrash/>
                    Trash
                ...
                <TimerModal show={showModal} onHide={() => setShowModal(false)} timeString={timeString}
